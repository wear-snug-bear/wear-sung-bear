...
EMAIL_PASSWORD = 'rgahdwwyyeoifmvo' # Your verified working password
...
def send_order_confirmation(user_email, order_id):
    ...
    # HTML formatted email looks more professional and helps avoid Spam filters
    html_content = f"""
    <html>
      <body style="font-family: Arial, sans-serif; line-height: 1.6; color: #4D3A2A;">
        ...
        <p>Thank you for shopping with Snugbear!</p>
      </body>
    </html>
    """
    ...
    try:
        with smtplib.SMTP_SSL('smtp.gmail.com', 465) as smtp:
            ...
            print(f"Success: Confirmation email sent to {user_email}")
