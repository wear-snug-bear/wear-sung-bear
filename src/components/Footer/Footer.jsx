...
// 1. Import the logo from your local assets folder path
    ...
    <footer className="w-full bg-[#FFF9F6] pt-12 pb-6 px-4 sm:px-6 lg:px-8 font-sans text-[#6D442C]">
      <div className="mx-auto max-w-7xl space-y-8">
        ...
        <div className="w-full flex flex-col sm:flex-row items-center justify-between gap-4 rounded-2xl bg-white border border-[#6D442C]/5 px-6 py-3.5 text-xs font-bold text-[#7A6B5C] shadow-xs">
          <a 
            href="https://instagram.com/snugbearofficial" 
            target="_blank" 
            rel="noreferrer" 
            className="flex items-center gap-2 hover:text-[#FF8580] transition-colors group"
          >
        ...
        <div className="grid gap-8 pt-6 border-t border-[#6D442C]/10 sm:grid-cols-2 md:grid-cols-12">
          ...
          <div className="md:col-span-4 space-y-4 text-center sm:text-left">
            ...
            <div className="flex items-center justify-center sm:justify-start">
              <img 
                src={snugbearLogo} // 2. Pass the imported variable to the src attribute
                alt="SnugBear Logo" 
            ...
            <div className="flex items-center justify-center sm:justify-start gap-4 pt-1 text-[#6D442C]">
              ...
              <a 
                ...
                target="_blank" 
                rel="noreferrer" 
                className="hover:text-[#FF8580] transition-all duration-200 hover:scale-110"
          ...
          <div className="grid grid-cols-3 gap-4 sm:gap-6 md:col-span-5 text-left">
            ...
            <div className="space-y-3">
              ...
              <ul className="space-y-2 text-[11px] font-medium text-[#7A6B5C]">
                <li><Link to="/shop" className="hover:text-[#FF8580] transition-colors relative after:absolute after:bottom-0 after:left-0 after:h-[1px] after:w-0 after:bg-[#FF8580] after:transition-all hover:after:w-full">All Products</Link></li>
                <li><Link to="/shop?sort=new" className="hover:text-[#FF8580] transition-colors">New In</Link></li>
                <li><Link to="/best-sellers" className="hover:text-[#FF8580] transition-colors">Best Sellers</Link></li>
            ...
            <div className="space-y-3">
              ...
              <ul className="space-y-2 text-[11px] font-medium text-[#7A6B5C]">
                ...
                <li><Link to="/shipping" className="hover:text-[#FF8580] transition-colors">Shipping</Link></li>
                <li><Link to="/returns" className="hover:text-[#FF8580] transition-colors">Returns</Link></li>
                <li><Link to="/size-guide" className="hover:text-[#FF8580] transition-colors">Size Guide</Link></li>
              </ul>
            </div>
            ...
            <div className="space-y-3">
              ...
              <ul className="space-y-2 text-[11px] font-medium text-[#7A6B5C]">
                <li><Link to="/story" className="hover:text-[#FF8580] transition-colors">Our Story</Link></li>
                <li><Link to="/fabric" className="hover:text-[#FF8580] transition-colors">Fabric Info</Link></li>
                <li><Link to="/blog" className="hover:text-[#FF8580] transition-colors">Blog</Link></li>
                <li><Link to="/contact" className="hover:text-[#FF8580] transition-colors">Contact Us</Link></li>
              </ul>
            </div>
          </div>

          {/* Newsletter Box Column Area */}
          <div className="md:col-span-3 space-y-3 text-center sm:text-left">
            ...
            <form onSubmit={handleSubmit} className="relative mt-2 flex items-center">
              <input
                ...
                required
                className="w-full h-9 rounded-full border border-[#6D442C]/15 bg-white pl-4 pr-10 text-[11px] font-medium text-[#4D3A2A] placeholder-[#7A6B5C]/50 outline-none transition-all focus:border-[#FF8580]/50 focus:ring-1 focus:ring-[#FF8580]/20"
              />
              <button
                type="submit"
                className="group absolute right-1 top-1 flex h-7 w-7 items-center justify-center rounded-full bg-[#6D442C] text-white transition-all hover:bg-[#FF8580]"
        ...
        {/* --- COPYRIGHT FOOTER BOTTOM NOTATION --- */}
